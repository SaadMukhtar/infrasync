...
def get_cookie_domain(url: str) -> Optional[str]:
    """
    Extract the cookie domain from a URL.
    For CloudFront or custom domains, returns the domain with a leading dot.
    For localhost, returns None (let browser handle it).

    Examples:
        https://d5qafayv450eu.cloudfront.net -> .d5qafayv450eu.cloudfront.net
    ...
    # Add leading dot for cross-subdomain compatibility

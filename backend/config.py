...
logger.info("(config):Starting config import...")
...
# Remove validation entirely - just log a warning if it's not a proper URL
if not FRONTEND_URL.startswith(("http://", "https://")):
    logger.warning(
        f"FRONTEND_URL should start with http:// or https:// (current: '{FRONTEND_URL}')"
    )

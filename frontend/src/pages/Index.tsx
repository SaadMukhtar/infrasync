    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50 overflow-x-hidden">
      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl overflow-x-hidden">
        ...
        <div className="text-center mb-12">
          ...
          {/* Product Screenshot */}
          <div className="flex flex-col md:flex-row justify-center items-center mb-12 gap-4 md:gap-10 w-full overflow-x-hidden">
            <img
              src="/dashboard.png"
              alt="Infrasync dashboard screenshot"
              className="rounded-xl shadow-lg max-w-full w-full md:w-auto h-auto border"
              style={{ maxHeight: 700 }}
            />
            <img
      ...
      {/* Sticky Sign up CTA */}
      <div className="fixed bottom-0 left-0 w-full bg-gradient-to-r from-blue-600 to-emerald-600 text-white py-4 flex flex-wrap justify-center md:justify-center items-center z-50 shadow-lg px-2 gap-2">
        <Button
          size="lg"
          className="bg-white text-blue-700 font-bold px-8 py-3 rounded-lg shadow hover:bg-slate-100 max-w-full"
          style={{ minWidth: 180 }}
          onClick={login}>

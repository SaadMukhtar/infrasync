...
export const OrgSettings = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-emerald-50">
      <div className="container mx-auto px-4 py-8 max-w-4xl w-full overflow-x-hidden">
        ...
        <div className="grid gap-6 w-full">
          {/* Organization Info */}
          <Card className="p-6 border-0 shadow-lg bg-white/80 backdrop-blur-sm max-w-full overflow-x-hidden box-border">
        ...
        {isAdmin && (
          <Card className="p-6 border-0 shadow-lg bg-white/80 backdrop-blur-sm mt-8 max-w-full overflow-x-hidden box-border">
            <div className="flex items-center gap-2 mb-4">
